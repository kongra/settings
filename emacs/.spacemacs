...
you should place your code here."
  ...
  (spacemacs/set-leader-keys "M-c" 'cua-copy-region)
  (spacemacs/set-leader-keys "M-x" 'cua-cut-region )
  (spacemacs/set-leader-keys "M-v" 'cua-paste      )
  ...
  (spacemacs/set-leader-keys "M-3" 'split-window-horizontally)
  (spacemacs/set-leader-keys "M-2" 'split-window-vertically  )
  (spacemacs/set-leader-keys "M-1" 'delete-other-windows     )
  ...
  (global-set-key [f5]     'hlt-highlight-symbol)
  (global-set-key [f6]   'hlt-unhighlight-symbol))
